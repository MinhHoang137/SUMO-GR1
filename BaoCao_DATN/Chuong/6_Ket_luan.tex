...
\begin{itemize}[leftmargin=2em]
	...
	\item \textbf{Nâng cấp mô hình lái, trả quyền và xử lý va chạm}: cải thiện
	động lực học phương tiện cho chế độ lái thủ công; hiện thực cơ chế tái nhập làn
	khi trả quyền — định vị xe về làn gần nhất, cấp tuyến mới và trả lại cho
	\gls{SUMO} thay vì xóa xe ngay, giúp xe hòa lại dòng giao thông tự nhiên
	hơn; đồng thời mở rộng hệ thống va chạm để xử lý cả va chạm giữa người đi
	bộ với xe, không chỉ giới hạn ở va chạm giữa xe với xe.
