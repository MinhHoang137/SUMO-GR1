...
nghiệp vụ chính đã được đặc tả trong Chương 2 (UC2, UC3, UC6, UC14, UC17, UC18).
...
\section{Đặc tả use case Chạy kịch bản định tuyến giao hàng}

\begin{table}[H]
	\centering
	\begin{tabular}{p{0.22\textwidth} p{0.70\textwidth}}
		\hline
		\textbf{Tên} & Chạy kịch bản định tuyến giao hàng \\
		\textbf{Tác nhân} & Người dùng \\
		\textbf{Mô tả} & Hệ thống sinh kịch bản trong đó các phương tiện xuất phát từ một điểm tập kết đi phục vụ nhiều điểm khách hàng theo lộ trình được tính toán. \\
		\textbf{Tiền điều kiện} & Đã có mạng đường hợp lệ. \\
		\textbf{Luồng chính} & (1) Người dùng chọn chế độ định tuyến giao hàng, số điểm khách hàng và số phương tiện. (2) Hệ thống dựng đồ thị mạng đường và chọn điểm tập kết cùng các điểm khách hàng. (3) Hệ thống phân bổ và tối ưu lộ trình cho từng phương tiện. (4) Hệ thống ghi các lộ trình ra tệp tuyến đường. \\
		\textbf{Luồng phụ} & (2a) Mạng không có nút hợp lệ: hệ thống báo lỗi và dừng. \\
		\textbf{Hậu điều kiện} & Tệp tuyến đường theo lộ trình giao hàng được tạo, sẵn sàng chạy. \\
		\hline
	\end{tabular}
\end{table}
