		...
		\begin{columns}[T]
			\begin{column}{0.58\textwidth}
				...
				\begin{tabular}{|p{0.08\linewidth}|p{0.52\linewidth}|c|}
					...
					\hline
					TC01 & Tách khung thông điệp TCP & \textcolor{green!60!black}{\textbf{Đạt}} \\ \hline
					TC02 & Nhận dữ liệu mạng đường, dựng cảnh & \textcolor{green!60!black}{\textbf{Đạt}} \\ \hline
					TC03 & Hiển thị trạng thái đèn tín hiệu & \textcolor{green!60!black}{\textbf{Đạt}} \\ \hline
					TC04 & Chiếm quyền và lái xe tương tác & \textcolor{green!60!black}{\textbf{Đạt}} \\ \hline
					TC05 & Va chạm sinh xác xe, tự dọn & \textcolor{green!60!black}{\textbf{Đạt}} \\ \hline
				\end{tabular}

				\vspace{0.6em}
				$\Rightarrow$ Tất cả 5 ca kiểm thử \textbf{đều đạt}. Hiện tượng duy nhất: lệch đồng bộ nhẹ khi tốc độ mô phỏng quá cao so với phần cứng.
			\end{column}
			\begin{column}{0.38\textwidth}
				\begin{minipage}[c][0.82\textheight][c]{\linewidth}
					\centering
